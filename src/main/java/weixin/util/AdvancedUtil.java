...
import weixin.model.message.resp.Music;
import weixin.model.pojo.*;
...
public class AdvancedUtil {
	...
	public static SNSUserInfo getSNSUserInfo(String accessToken, String openId) {
		...
		if (null != jsonObject) {
            logger.info("已经获取到了用户信息"+jsonObject.toString());
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getToken("wxb67cf3f14d6861e4", "90371de91616f7139074d6f4f51bb78d").getAccessToken();
