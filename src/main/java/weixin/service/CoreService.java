		...
		try {
			...
			if (msgType.equals(MessageUtil.REQ_MESSAGE_TYPE_EVENT)) {
				...
				if (eventType.equals(MessageUtil.EVENT_TYPE_SUBSCRIBE)) {
					...
					/*textMessage.setContent("您好,欢迎加入阳光的测试。体验生活，从这里开始！");
					// 将消息对象转换成xml
...
//						article.setPicUrl("");
                    article.setPicUrl("http://yxyhsk.6655.la/weixin/images/subscribe.jpg");
...
//						article.setDescription("开源中国社区成立于2008年8月，是目前中国最大的开源技术社区。\n\n开源中国的目的是为中国的IT技术人员提供一个全面的、快捷更新的用来检索开源软件以及交流开源经验的平台。\n\n经过不断的改进,目前开源中国社区已经形成了由开源软件库、代码分享、资讯、讨论区和博客等几大频道内容。");
						article.setPicUrl("http://yxyhsk.6655.la/weixin/images/shuhuabuluo.jpg");
